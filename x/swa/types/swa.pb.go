...
type Params struct {
	...
	SwaAdmin             string `protobuf:"bytes,3,opt,name=swa_admin,json=swaAdmin,proto3" json:"swa_admin,omitempty"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_aee3a6a165298fec, []int{0}
}
...
func (m *Params) GetSwaAdmin() string {
	if m != nil {
		return m.SwaAdmin
	}
	return ""
...
func (*TokenMappingChangeProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_aee3a6a165298fec, []int{1}
}
...
func (*TokenMapping) Descriptor() ([]byte, []int) {
	return fileDescriptor_aee3a6a165298fec, []int{2}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "swa.Params")
	proto.RegisterType((*TokenMappingChangeProposal)(nil), "swa.TokenMappingChangeProposal")
	proto.RegisterType((*TokenMapping)(nil), "swa.TokenMapping")
}

func init() { proto.RegisterFile("swa/swa.proto", fileDescriptor_aee3a6a165298fec) }

var fileDescriptor_aee3a6a165298fec = []byte{
	// 445 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxCallbackGas != 0 {
		i = encodeVarintSwa(dAtA, i, uint64(m.MaxCallbackGas))
		i--
		dAtA[i] = 0x28
	}
	...
	if len(m.SwaAdmin) > 0 {
		i -= len(m.SwaAdmin)
		copy(dAtA[i:], m.SwaAdmin)
		i = encodeVarintSwa(dAtA, i, uint64(len(m.SwaAdmin)))
		i--
		dAtA[i] = 0x1a
	}
	if m.IbcTimeout != 0 {
		i = encodeVarintSwa(dAtA, i, uint64(m.IbcTimeout))
		i--
		dAtA[i] = 0x10
	}
	if len(m.IbcCroDenom) > 0 {
		...
		i = encodeVarintSwa(dAtA, i, uint64(len(m.IbcCroDenom)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *TokenMappingChangeProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Decimal != 0 {
		i = encodeVarintSwa(dAtA, i, uint64(m.Decimal))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Symbol) > 0 {
		...
		i = encodeVarintSwa(dAtA, i, uint64(len(m.Symbol)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Contract) > 0 {
		...
		i = encodeVarintSwa(dAtA, i, uint64(len(m.Contract)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintSwa(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Description) > 0 {
		...
		i = encodeVarintSwa(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintSwa(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintSwa(dAtA []byte, offset int, v uint64) int {
	offset -= sovSwa(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Params) Size() (n int) {
	...
	l = len(m.IbcCroDenom)
	if l > 0 {
		n += 1 + l + sovSwa(uint64(l))
	}
	if m.IbcTimeout != 0 {
		n += 1 + sovSwa(uint64(m.IbcTimeout))
	}
	l = len(m.SwaAdmin)
	if l > 0 {
		n += 1 + l + sovSwa(uint64(l))
	...
	if m.MaxCallbackGas != 0 {
		n += 1 + sovSwa(uint64(m.MaxCallbackGas))
	}
	return n
}
...
func sovSwa(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozSwa(x uint64) (n int) {
	return sovSwa(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SwaAdmin", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SwaAdmin = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
...
func skipSwa(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupSwa
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthSwa        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowSwa          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupSwa = fmt.Errorf("proto: unexpected end of group")
)
